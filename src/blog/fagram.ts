...
export const article1: ArticleContent = {
  ...
  sections: [
    ...
    {
      type: 'paragraph',
      content: 'You can install fagram from AUR. If you have an AUR helper like yay, you can run:'
    },
    {
      type: 'code',
...
sudo dnf install fagram`,
    ...
    {
      type: 'paragraph',
      content: 'You can install fagram from <a href="https://github.com/burhancodes/fagram-deb" target="_blank">github hosted DEB package repo</a>, you can run:'
    },
    {
      type: 'code',
