...
function copyDiscordHandle() {
  navigator.clipboard.writeText("burhanverse");
  copied.value = true;
  setTimeout(() => {
    copied.value = false;
  }, 2500);
...
.profile-avatar-img {
  ...
  border-radius: 24px;
  object-fit: cover;
  border: 2px solid var(--md-sys-color-outline-variant, rgba(191, 96, 56, 0.25));
