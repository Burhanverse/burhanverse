    ...
    return (
        <Card className="bg-gray-800 border-none text-white rounded-2xl shadow-lg overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-teal-800 to-teal-600 p-8">
                <h1 className="text-4xl font-bold text-white mb-4">FAgram Desktop</h1>
            ...
            <CardContent className="p-8">
                ...
                <h6 className="text-xs text-italic text-gray-300  "><i>All mentioned linux packages are maintained by <a className="text-teal-400" href="https://github.com/burhanverse">@burhanverse</a></i></h6>
                <div className="half-space"></div>
                <p className="text-s text-gray-300  ">
                    <a className="text-teal-400" href="https://aur.archlinux.org/packages/fagram-bin">FAgram Arch Repository</a>
                </p>
                <div className="half-space"></div>
                <p className="text-s text-gray-300  ">
                ...
                <p className="text-s text-gray-300  ">
                    <a className="text-teal-400" href="https://copr.fedorainfracloud.org/coprs/burhanverse/fagram/">FAgram Copr Repository</a>
                </p>
                <div className="half-space"></div>
                <p className="text-s text-gray-300  ">
                    ⦿ Add the repository and install FAgram Desktop:
                </p>
                <div className="half-space"></div>
                <pre className="relative group rounded-lg overflow-hidden bg-gray-900">
                    <div className="flex justify-between items-center bg-gray-700 px-2 py-2">
                ...
                <p className="text-s text-gray-300  ">
                    <a className="text-teal-400" href="https://github.com/burhancodes/fagram-deb ">FAgram Debian/Ubuntu Repository</a>
                </p>
                <div className="half-space"></div>
                <p className="text-s text-gray-300  ">
                    ⦿ You can use this installer script:
